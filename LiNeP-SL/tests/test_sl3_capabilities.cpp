...
int main() {
    std::cout << "[test_sl3_capabilities] Starting LiNeP-SL SL3 Capability unit tests..." << std::endl;
    ...
    assert(read_ok == true);
    std::cout << "[test_sl3_capabilities] Valid token with CAP_INFERENCE_READ PASSED" << std::endl;
    ...
    std::cout << "[test_sl3_capabilities] Reject missing capability (CAP_ADMIN) PASSED" << std::endl;
    ...
    std::cout << "[test_sl3_capabilities] Reject expired token PASSED" << std::endl;
    ...
    std::cout << "[test_sl3_capabilities] Reject tampered capability bitmask PASSED" << std::endl;

    std::cout << "[test_sl3_capabilities] ALL SL3 CAPABILITY TESTS PASSED SUCCESSFULLY!" << std::endl;
    return 0;
}
